...
data class Folkeregisterettilgjengeliggjoeringpersonv1InnflyttingTilNorge (
    ...
    class Deserializer : JsonDeserializer<Folkeregisterettilgjengeliggjoeringpersonv1InnflyttingTilNorge>() {
        override fun deserialize(p: JsonParser, ctx: DeserializationContext): Folkeregisterettilgjengeliggjoeringpersonv1InnflyttingTilNorge {
            ...
            return Folkeregisterettilgjengeliggjoeringpersonv1InnflyttingTilNorge(
