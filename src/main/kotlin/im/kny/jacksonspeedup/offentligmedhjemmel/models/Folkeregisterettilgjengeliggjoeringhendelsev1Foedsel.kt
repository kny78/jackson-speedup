...
data class Folkeregisterettilgjengeliggjoeringhendelsev1Foedsel (

    @field:JsonProperty("foedselsaar")
    val foedselsaar: kotlin.String,
    ...
    @field:JsonProperty("foedekommuneINorge")
    val foedekommuneINorge: kotlin.String? = null,

    @field:JsonProperty("foedeland")
    val foedeland: kotlin.String? = null,

    @field:JsonProperty("foedested")
    ...
    class ParsedValues{
        var foedselsaar: kotlin.String? = null
        var aarsak: kotlin.String? = null
        var ajourholdstidspunkt: java.time.OffsetDateTime? = null
        var foedekommuneINorge: kotlin.String? = null
        var foedeland: kotlin.String? = null
        var foedested: kotlin.String? = null
    ...
    class Deserializer : JsonDeserializer<Folkeregisterettilgjengeliggjoeringhendelsev1Foedsel>() {
        override fun deserialize(p: JsonParser, ctx: DeserializationContext): Folkeregisterettilgjengeliggjoeringhendelsev1Foedsel {
            ...
            while (curr == JsonToken.FIELD_NAME) {
                ...
                curr = p.nextToken()
                when (field) {
                    "foedselsaar" -> parsedValues.foedselsaar = p.text
                    ...
                    "foedekommuneINorge" -> parsedValues.foedekommuneINorge = p.text
                    "foedeland" -> parsedValues.foedeland = p.text
                    "foedested" -> parsedValues.foedested = p.text
            ...
            return Folkeregisterettilgjengeliggjoeringhendelsev1Foedsel(
                foedselsaar = parsedValues.foedselsaar!!,
                aarsak = parsedValues.aarsak,
                ajourholdstidspunkt = parsedValues.ajourholdstidspunkt,
                foedekommuneINorge = parsedValues.foedekommuneINorge,
                foedeland = parsedValues.foedeland,
                foedested = parsedValues.foedested,
