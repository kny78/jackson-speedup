 ...
 */
data class Folkeregisterettilgjengeliggjoeringhendelsev1SametingetsValgmanntall(
    @field:JsonProperty("forhold")
    val forhold: Folkeregisterettilgjengeliggjoeringhendelsev1SametingetsValgmanntall.Forhold,
...
) 
{
    ...
    */
    ...
    class ParsedValues{
        var forhold: Folkeregisterettilgjengeliggjoeringhendelsev1SametingetsValgmanntall.Forhold? = null
    ...
    class Deserializer : JsonDeserializer<Folkeregisterettilgjengeliggjoeringhendelsev1SametingetsValgmanntall>() {
        override fun deserialize(p: JsonParser, ctx: DeserializationContext): Folkeregisterettilgjengeliggjoeringhendelsev1SametingetsValgmanntall {
            ...
            while (curr == JsonToken.FIELD_NAME) {
                ...
                when (field) {
                    ...
                    "forhold" -> parsedValues.forhold = Folkeregisterettilgjengeliggjoeringhendelsev1SametingetsValgmanntall.Forhold.valueOf(p.text)
            ...
            return Folkeregisterettilgjengeliggjoeringhendelsev1SametingetsValgmanntall(
