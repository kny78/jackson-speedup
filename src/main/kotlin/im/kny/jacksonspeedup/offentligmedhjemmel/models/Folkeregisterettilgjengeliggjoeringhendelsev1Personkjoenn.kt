...
data class Folkeregisterettilgjengeliggjoeringhendelsev1Personkjoenn (

    @field:JsonProperty("kjoenn")
    val kjoenn: Folkeregisterettilgjengeliggjoeringhendelsev1Personkjoenn.Kjoenn,
    ...
    class ParsedValues{
        var kjoenn: Folkeregisterettilgjengeliggjoeringhendelsev1Personkjoenn.Kjoenn? = null
    ...
    class Deserializer : JsonDeserializer<Folkeregisterettilgjengeliggjoeringhendelsev1Personkjoenn>() {
        override fun deserialize(p: JsonParser, ctx: DeserializationContext): Folkeregisterettilgjengeliggjoeringhendelsev1Personkjoenn {
            ...
            while (curr == JsonToken.FIELD_NAME) {
                ...
                when (field) {
                    ...
                    "kjoenn" -> parsedValues.kjoenn = Folkeregisterettilgjengeliggjoeringhendelsev1Personkjoenn.Kjoenn.valueOf(p.text)
            ...
            return Folkeregisterettilgjengeliggjoeringhendelsev1Personkjoenn(
